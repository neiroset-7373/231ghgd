...
const WintoBloxMobileLobby: React.FC = () => {
  ...
  return (
    <div className="lobby-container mobile">
      {/* Logo */}
      <div className="logo-container">
        <img src="../logos/mini_logo-_2_.svg" alt="WintoBlox" className="mobile-logo" />
      </div>
...
export default WintoBloxMobileLobby;
